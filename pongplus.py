...
if os.path.exists("popconf.ini"):
    print("you have been banned from pongPLUS for your actions.")
    sys.exit()
...
pygame.display.set_caption("pongPLUS")
...
def main():
    ...
    geek1 = Striker(20, 0, 10, 100, 10, WHITE)
